...
def main():
 ...
 (ROOT/'reports/placement-45x37-usb2.json').write_text(json.dumps(output,indent=2));print(output['summary']);print('overlaps',overlaps)
 ...
 svg.append('</svg>');(ROOT/'reports/placement-45x37-usb2.svg').write_text(''.join(svg))
